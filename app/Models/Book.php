...
class Book extends Model
{
    ...
    {
        // Beim verwenden von SQLite muss explizit "groupBy" verwendet werden, in verbindung mit "having"
        return $query->groupBy("reviews_count")->having('reviews_count', '>=', $minReviews);
    }
